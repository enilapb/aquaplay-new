...
joo.classLoader.prepare(
    "package TestBed",
    "public class TestBreakable extends TestBed.Test", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2Body, Main, Math);
        },
            "public function TestBreakable", function () {
                this.super$2();
                this.m_velocity = this.m_velocity();
                this.m_shape1 = this.m_shape1();
                this.m_shape2 = this.m_shape2();
            ...
            "public var", {m_velocity:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {m_angularVelocity:NaN},
            "public var", {m_shape1:function () {
                return(new Box2D.Collision.Shapes.b2PolygonShape());
            }},
            "public var", {m_shape2:function () {
                return(new Box2D.Collision.Shapes.b2PolygonShape());
            }},
            ...
            "class ContactListener extends Box2D.Dynamics.b2EmptyContactListener", 2, function ($$private) {
                ;
                return[
...
joo.classLoader.prepare(
    "package TestBed",
    "public class TestBridge extends TestBed.Test", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2Body, Main, Math);
        },
            "public function TestBridge", function () {
                this.super$2();
...
joo.classLoader.prepare(
    ...
    "public class TestCCD extends TestBed.Test", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2Body, Main);
        },
            "public function TestCCD", function () {
                this.super$2();
...
joo.classLoader.prepare(
    "package TestBed",
    "public class TestCompound extends TestBed.Test", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2Body, Main, Math);
        },
            "public function TestCompound", function () {
                this.super$2();
...
joo.classLoader.prepare(
    "package TestBed",
    "public class TestCrankGearsPulley extends TestBed.Test", 2, function ($$private) {
        var as = joo.as;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2Body, Main, Math);
        },
            "public function TestCrankGearsPulley", function () {
                this.super$2();
...
joo.classLoader.prepare(
    "package TestBed",
    "public class TestOneSidedPlatform extends TestBed.Test", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2Body, Main);
        },
            "public function TestOneSidedPlatform", function () {
                this.super$2();
...
joo.classLoader.prepare(
    "package TestBed",
    "public class TestRagdoll extends TestBed.Test", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2Body, Main, Math);
        },
            "public function TestRagdoll", function () {
                this.super$2();
...
joo.classLoader.prepare(
    "package TestBed",
    "public class TestRaycast extends TestBed.Test", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2Body, Main, Math);
        },
            "public var", {laser:null},
            "public function TestRaycast", function () {
                this.super$2();
...
joo.classLoader.prepare(
    "package TestBed",
    "public class TestSensor extends TestBed.Test", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Main, Box2D.Dynamics.b2Body);
        },
            "public function TestSensor", function () {
                this.super$2();
                var fd = new Box2D.Dynamics.b2FixtureDef();
            ...
            "internal class MyController extends Box2D.Dynamics.Controllers.b2Controller", 2, function ($$private) {
                ;
                return[
                    ...
                    "public function MyController", function MyController$() {
                        this.super$2();
                        this.position = this.position();
                    }];
            }, [], ];
    }, [], ["TestBed.Test", "Box2D.Dynamics.b2FixtureDef", "Box2D.Collision.Shapes.b2CircleShape", "Box2D.Dynamics.b2BodyDef", "Box2D.Dynamics.b2Body", "Box2D.Dynamics.Controllers.b2TouchingBodyIterable", "Main", "Box2D.Dynamics.Controllers.b2Controller", "Box2D.Common.Math.b2Vec2", "Box2D.Common.Math.b2Math"], "0.8.0", "0.8.1"
);
// class TestBed.TestStack
joo.classLoader.prepare(
    "package TestBed",
    "public class TestStack extends TestBed.Test", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2Body, Main);
        },
            "public function TestStack", function () {
                this.super$2();
...
joo.classLoader.prepare(
    "package TestBed",
    "public class TestTheoJansen extends TestBed.Test", 2, function ($$private) {
        var as = joo.as;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2Body, Main, Math);
        },
            "public function TestTheoJansen", function () {
                this.super$2();
                this.m_offset$2 = this.m_offset$2();
