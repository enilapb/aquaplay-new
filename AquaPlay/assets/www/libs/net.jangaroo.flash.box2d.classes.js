...
joo.classLoader.prepare(
    ...
    "public class b2AABB", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Number);
        },
            ...
            "public var", {lowerBound:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {upperBound:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public function b2AABB", function b2AABB$() {
                this.lowerBound = this.lowerBound();
                this.upperBound = this.upperBound();
            }];
    }, ["Combine"], ["Box2D.Common.Math.b2Vec2", "Number", "Math"], "0.8.0", "0.8.1"
);
// class Box2D.Collision.b2Collision
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2Collision", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Collision.b2Manifold, Number, Box2D.Common.b2Settings);
        },
            ...
            "static public function EdgeSeparation", function (poly1, xf1, edge1, poly2, xf2) {
            ...
            "static public function FindMaxSeparation", function (edgeIndex, poly1, xf1, poly2, xf2) {
                var count1 = poly1.m_vertexCount;
                var normals1 = poly1.m_normals;
                var tVec;
                var tMat;
            ...
            "static public function FindIncidentEdge", function (c, poly1, xf1, edge1, poly2, xf2) {
                var count1 = poly1.m_vertexCount;
                var normals1 = poly1.m_normals;
                var count2 = poly2.m_vertexCount;
                var vertices2 = poly2.m_vertices;
            ...
            "private static var", {s_incidentEdge:function () {
                return($$private.MakeClipPointVector());
            }},
            "private static var", {s_clipPoints1:function () {
                return($$private.MakeClipPointVector());
            }},
            "private static var", {s_clipPoints2:function () {
                return($$private.MakeClipPointVector());
            }},
            "private static var", {s_edgeAO:function () {
                return(new Array(1));
            }},
            "private static var", {s_edgeBO:function () {
                return(new Array(1));
            }},
            "private static var", {s_localTangent:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private static var", {s_localNormal:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private static var", {s_planePoint:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private static var", {s_normal:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private static var", {s_tangent:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private static var", {s_tangent2:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private static var", {s_v11:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private static var", {s_v12:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "static private var", {b2CollidePolyTempVec:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "static public function CollidePolygons", function (manifold, polyA, xfA, polyB, xfB) {
                var cv;
            ...
            "static public function CollideCircles", function (manifold, circle1, xf1, circle2, xf2) {
                manifold.m_pointCount = 0;
                var tMat;
                var tVec;
                tMat = xf1.R;
            ...
            "static public function CollidePolygonAndCircle", function (manifold, polygon, xf1, circle, xf2) {
                manifold.m_pointCount = 0;
                var tPoint;
                var dX;
                var dY;
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2ContactID", 1, function ($$private) {
        ;
        return[

            "public function b2ContactID", function () {
            ...
            "public var", {features:function () {
                return(new Box2D.Collision.Features());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2ContactPoint", 1, function ($$private) {
        ;
        return[

            "public var", {shape1:null},
            "public var", {shape2:null},
            "public var", {position:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {velocity:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {normal:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {separation:NaN},
            "public var", {friction:NaN},
            "public var", {restitution:NaN},
            "public var", {id:function () {
                return(new Box2D.Collision.b2ContactID());
            }},
            "public function b2ContactPoint", function b2ContactPoint$() {
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2Distance", 1, function ($$private) {
        var assert = joo.assert;
        return[function () {
            joo.classLoader.init(Number);
        },
            ...
            "private static var", {s_simplex:function () {
                return(new Box2D.Collision.b2Simplex());
            }},
            "private static var", {s_saveA:function () {
                return(new Array(3));
            }},
            "private static var", {s_saveB:function () {
                return(new Array(3));
            }},
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2DistanceInput", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2DistanceOutput", 1, function ($$private) {
        ;
        return[

            "public var", {pointA:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }}, "public var", {pointB:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }}, "public var", {distance:NaN},
            "public var", {iterations:0}, "public function b2DistanceOutput", function b2DistanceOutput$() {
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2DistanceProxy", 1, function ($$private) {
        var as = joo.as, assert = joo.assert;
        return[function () {
            joo.classLoader.init(Box2D.Collision.Shapes.b2Shape);
        },
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2DynamicTree", 1, function ($$private) {
        var assert = joo.assert;
        return[function () {
            joo.classLoader.init(Box2D.Common.b2Settings);
        },
            ...
            "private static var", {s_stack:function () {
                return(new Array());
            }},
...
joo.classLoader.prepare("package Box2D.Collision",
    "public class b2DynamicTreeBroadPhase implements Box2D.Collision.IBroadPhase", 1, function ($$private) {
        ;
        return[
            ...
            "private var", {m_tree:function () {
                return(new Box2D.Collision.b2DynamicTree());
            }},
            "private var", {m_proxyCount:0},
            "private var", {m_moveBuffer:function () {
                return(new Array());
            }},
            "private var", {m_pairBuffer:function () {
                return(new Array());
            }},
            "private var", {m_pairCount:0},
            "public function b2DynamicTreeBroadPhase", function b2DynamicTreeBroadPhase$() {
                this.m_tree$1 = this.m_tree$1();
                this.m_moveBuffer$1 = this.m_moveBuffer$1();
                this.m_pairBuffer$1 = this.m_pairBuffer$1();
            }];
    }, [], ["Box2D.Collision.IBroadPhase", "Box2D.Collision.b2DynamicTreePair", "Box2D.Collision.b2DynamicTree", "Array"], "0.8.0", "0.8.1"
);
// class Box2D.Collision.b2DynamicTreeNode
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2DynamicTreeNode", 1, function ($$private) {
        ;
        return[
            ...
            "public var", {aabb:function () {
                return(new Box2D.Collision.b2AABB());
            }},
            "public var", {parent:null},
            "public var", {child1:null},
            "public var", {child2:null},
            "public function b2DynamicTreeNode", function b2DynamicTreeNode$() {
                this.aabb = this.aabb();
            }];
    }, [], ["Box2D.Collision.b2AABB"], "0.8.0", "0.8.1"
);
// class Box2D.Collision.b2DynamicTreePair
joo.classLoader.prepare("package Box2D.Collision",
    "public class b2DynamicTreePair", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2Manifold", 1, function ($$private) {
        var as = joo.as;
        return[function () {
            joo.classLoader.init(Box2D.Common.b2Settings);
        },
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2ManifoldPoint", 1, function ($$private) {
        ;
        return[

            "public function b2ManifoldPoint", function () {
                this.m_localPoint = this.m_localPoint();
                this.m_id = this.m_id();
                this.Reset();
            },
            "public function Reset", function () {
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2OBB", 1, function ($$private) {
        ;
        return[
            ...
            "public var", {extents:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public function b2OBB", function b2OBB$() {
                this.R = this.R();
                this.center = this.center();
                this.extents = this.extents();
            }];
    }, [], ["Box2D.Common.Math.b2Mat22", "Box2D.Common.Math.b2Vec2"], "0.8.0", "0.8.1"
);
// class Box2D.Collision.b2Point
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2Point", 1, function ($$private) {
        ;
        return[
            ...
            "public function b2Point", function b2Point$() {
                this.p = this.p();
            }];
    }, [], ["Box2D.Common.Math.b2Vec2"], "0.8.0", "0.8.1"
);
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2RayCastInput", 1, function ($$private) {
        ;
        return[
            ...
            "public var", {p1:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {p2:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2RayCastOutput", 1, function ($$private) {
        ;
        return[
            ...
            "public function b2RayCastOutput", function b2RayCastOutput$() {
                this.normal = this.normal();
            }];
    }, [], ["Box2D.Common.Math.b2Vec2"], "0.8.0", "0.8.1"
);
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "internal class b2SeparationFunction", 1, function ($$private) {
        var assert = joo.assert;
        return[
            ...
            "public function Initialize", function (cache, proxyA, transformA, proxyB, transformB) {
            ...
            "public var", {m_axis:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public function b2SeparationFunction", function b2SeparationFunction$() {
                this.m_localPoint = this.m_localPoint();
                this.m_axis = this.m_axis();
            }];
    }, [], ["Box2D.Common.Math.b2Math", "Box2D.Common.Math.b2Vec2"], "0.8.0", "0.8.1"
);
// class Box2D.Collision.b2Simplex
joo.classLoader.prepare(
    "package Box2D.Collision",
    "internal class b2Simplex", 1, function ($$private) {
        var assert = joo.assert;
        return[function () {
            joo.classLoader.init(Number);
        },
            ...
            "public function b2Simplex", function () {
                ...
                this.m_v2 = this.m_v2();
                this.m_v3 = this.m_v3();
                this.m_vertices = this.m_vertices();
                this.m_vertices[0] = this.m_v1;
                this.m_vertices[1] = this.m_v2;
                this.m_vertices[2] = this.m_v3;
            },
            "public function ReadCache", function (cache, proxyA, transformA, proxyB, transformB) {
                var wALocal;
                var wBLocal;
            ...
            "public var", {m_v1:function () {
                return(new Box2D.Collision.b2SimplexVertex());
            }},
            "public var", {m_v2:function () {
                return(new Box2D.Collision.b2SimplexVertex());
            }},
            "public var", {m_v3:function () {
                return(new Box2D.Collision.b2SimplexVertex());
            }},
            "public var", {m_vertices:function () {
                return(new Array(3));
            }},
            "public var", {m_count:0},
        ];
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2SimplexCache", 1, function ($$private) {
        ;
        return[

            "public var", {metric:NaN},
            "public var", {count:0},
            "public var", {indexA:function () {
                return(new Array(3));
            }},
            "public var", {indexB:function () {
                return(new Array(3));
            }},
            "public function b2SimplexCache", function b2SimplexCache$() {
                this.indexA = this.indexA();
                this.indexB = this.indexB();
            }];
    }, [], ["Array"], "0.8.0", "0.8.1"
);
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "internal class b2SimplexVertex", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2TimeOfImpact", 1, function ($$private) {
        var assert = joo.assert;
        return[function () {
            joo.classLoader.init(Number);
        },
            ...
            "private static var", {s_cache:function () {
                return(new Box2D.Collision.b2SimplexCache());
            }},
            "private static var", {s_distanceInput:function () {
                return(new Box2D.Collision.b2DistanceInput());
            }},
            "private static var", {s_xfA:function () {
                return(new Box2D.Common.Math.b2Transform());
            }},
            "private static var", {s_xfB:function () {
                return(new Box2D.Common.Math.b2Transform());
            }},
            "private static var", {s_fcn:function () {
                return(new Box2D.Collision.b2SeparationFunction());
            }},
            "private static var", {s_distanceOutput:function () {
                return(new Box2D.Collision.b2DistanceOutput());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2TOIInput", 1, function ($$private) {
        ;
        return[

            "public var", {proxyA:function () {
                return(new Box2D.Collision.b2DistanceProxy());
            }},
            "public var", {proxyB:function () {
                return(new Box2D.Collision.b2DistanceProxy());
            }},
            "public var", {sweepA:function () {
                return(new Box2D.Common.Math.b2Sweep());
            }},
            "public var", {sweepB:function () {
                return(new Box2D.Common.Math.b2Sweep());
            }},
            "public var", {tolerance:NaN},
            "public function b2TOIInput", function b2TOIInput$() {
                this.proxyA = this.proxyA();
                this.proxyB = this.proxyB();
                this.sweepA = this.sweepA();
                this.sweepB = this.sweepB();
            }];
    }, [], ["Box2D.Collision.b2DistanceProxy", "Box2D.Common.Math.b2Sweep"], "0.8.0", "0.8.1"
);
// class Box2D.Collision.b2WorldManifold
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class b2WorldManifold", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Collision.b2Manifold, Number, Box2D.Common.b2Settings);
        },
            ...
            "public function Initialize", function (manifold, xfA, radiusA, xfB, radiusB) {
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class ClipVertex", 1, function ($$private) {
        ;
        return[
            ...
            "public function ClipVertex", function ClipVertex$() {
                this.v = this.v();
                this.id = this.id();
            }];
    }, [], ["Box2D.Common.Math.b2Vec2", "Box2D.Collision.b2ContactID"], "0.8.0", "0.8.1"
...
joo.classLoader.prepare(
    "package Box2D.Collision",
    "public class Features", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare("package Box2D.Collision",
    "public interface IBroadPhase", 1, function ($$private) {
        ;
        return[
            , , , , , , , , , , , ,
        ];
...
joo.classLoader.prepare(
    ...
    "public class b2CircleShape extends Box2D.Collision.Shapes.b2Shape", 2, function ($$private) {
        var is = joo.is, as = joo.as, assert = joo.assert;
        return[function () {
            joo.classLoader.init(Number, Math, Box2D.Common.b2Settings);
        },
            ...
            "public override function ComputeSubmergedArea", function (normal, offset, xf, c) {
            ...
            "public function b2CircleShape", function (radius) {
                if (arguments.length < 1) {
                    radius = 0;
                }
                this.super$2();
...
joo.classLoader.prepare(
    "package Box2D.Collision.Shapes",
    "public class b2MassData", 1, function ($$private) {
        ;
        return[
            ...
            "public var", {I:0.0},
            "public function b2MassData", function b2MassData$() {
                this.center = this.center();
            }];
    }, [], ["Box2D.Common.Math.b2Vec2"], "0.8.0", "0.8.1"
);
...
joo.classLoader.prepare(
    "package Box2D.Collision.Shapes",
    "public class b2PolygonShape extends Box2D.Collision.Shapes.b2Shape", 2, function ($$private) {
        var is = joo.is, as = joo.as, assert = joo.assert;
        return[function () {
            joo.classLoader.init(Number, Box2D.Common.b2Settings);
        },
            ...
            "static private var", {s_mat:function () {
                return(new Box2D.Common.Math.b2Mat22());
            }},
            ...
            "public function b2PolygonShape", function () {
                this.super$2();
...
joo.classLoader.prepare(
    "package Box2D.Collision.Shapes",
    "public class b2PolyLine extends Box2D.Collision.Shapes.b2Shape", 2, function ($$private) {
        ;
        return[

            "public var", {vertices:function () {
                return(new Array());
            }},
            "public var", {isALoop:false},
            "public function b2PolyLine", function b2PolyLine$() {
                this.super$2();
                this.vertices = this.vertices();
            }];
    }, [], ["Box2D.Collision.Shapes.b2Shape", "Array"], "0.8.0", "0.8.1"
);
// class Box2D.Collision.Shapes.b2Shape
joo.classLoader.prepare(
    "package Box2D.Collision.Shapes",
    "public class b2Shape", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Number, Box2D.Common.b2Settings);
        },
            ...
            "public virtual function TestPoint", function (xf, p) {
                return false;
            },
            ...
            "public virtual function ComputeSubmergedArea", function (normal, offset, xf, c) {
                return 0;
            },
...
joo.classLoader.prepare(
    ...
    "public class b2Color", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Common",
    "public class b2Settings", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Math);
        },
            "static public const", {VERSION:"2.1beta"},
            "static public const", {USHRT_MAX:0x0000ffff},
            "static public const", {b2_pi:function () {
                return(Math.PI);
            }},
            ...
            "static public const", {b2_polygonRadius:function () {
                return(2.0 * Box2D.Common.b2Settings.b2_linearSlop);
            }},
            "static public const", {b2_linearSlop:0.005},
            "static public const", {b2_angularSlop:function () {
                return(2.0 / 180.0 * Box2D.Common.b2Settings.b2_pi);
            }},
            "static public const", {b2_toiSlop:function () {
                return(8.0 * Box2D.Common.b2Settings.b2_linearSlop);
            }},
            ...
            "static public const", {b2_maxAngularCorrection:function () {
                return(8.0 / 180.0 * Box2D.Common.b2Settings.b2_pi);
            }},
            "static public const", {b2_maxTranslation:2.0},
            "static public const", {b2_maxTranslationSquared:function () {
                return(Box2D.Common.b2Settings.b2_maxTranslation * Box2D.Common.b2Settings.b2_maxTranslation);
            }},
            "static public const", {b2_maxRotation:function () {
                return(0.5 * Box2D.Common.b2Settings.b2_pi);
            }},
            "static public const", {b2_maxRotationSquared:function () {
                return(Box2D.Common.b2Settings.b2_maxRotation * Box2D.Common.b2Settings.b2_maxRotation);
            }},
            ...
            "static public const", {b2_angularSleepTolerance:function () {
                return(2.0 / 180.0 * Box2D.Common.b2Settings.b2_pi);
            }},
...
joo.classLoader.prepare(
    ...
    "public class b2Mat22", 1, function ($$private) {
        ;
        return[
            ...
            "public var", {col1:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {col2:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
        ];
...
joo.classLoader.prepare(
    "package Box2D.Common.Math",
    "public class b2Mat33", 1, function ($$private) {
        ;
        return[
            ...
            "public var", {col1:function () {
                return(new Box2D.Common.Math.b2Vec3());
            }},
            "public var", {col2:function () {
                return(new Box2D.Common.Math.b2Vec3());
            }},
            "public var", {col3:function () {
                return(new Box2D.Common.Math.b2Vec3());
            }},
        ];
...
joo.classLoader.prepare(
    "package Box2D.Common.Math",
    "public class b2Math", 1, function ($$private) {
        ;
        return[
            ...
            "static public const", {b2Vec2_zero:function () {
                return(new Box2D.Common.Math.b2Vec2(0.0, 0.0));
            }},
            "static public const", {b2Mat22_identity:function () {
                return(Box2D.Common.Math.b2Mat22.FromVV(new Box2D.Common.Math.b2Vec2(1.0, 0.0), new Box2D.Common.Math.b2Vec2(0.0, 1.0)));
            }},
            "static public const", {b2Transform_identity:function () {
                return(new Box2D.Common.Math.b2Transform(Box2D.Common.Math.b2Math.b2Vec2_zero, Box2D.Common.Math.b2Math.b2Mat22_identity));
            }},
        ];
...
joo.classLoader.prepare(
    "package Box2D.Common.Math",
    "public class b2Sweep", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Number);
        },
            ...
            "public var", {localCenter:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {c0:function () {
                return(new Box2D.Common.Math.b2Vec2);
            }},
            ...
            "public var", {a:NaN},
            "public var", {t0:NaN},
            "public function b2Sweep", function b2Sweep$() {
                this.localCenter = this.localCenter();
                this.c0 = this.c0();
                this.c = this.c();
            }];
    }, [], ["Number", "Box2D.Common.Math.b2Vec2"], "0.8.0", "0.8.1"
);
// class Box2D.Common.Math.b2Transform
joo.classLoader.prepare(
    "package Box2D.Common.Math",
    "public class b2Transform", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Common.Math",
    "public class b2Vec2", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Number);
        },

            "public function b2Vec2", function (x_, y_) {
                if (arguments.length < 2) {
                    if (arguments.length < 1) {
                        x_ = 0;
                    }
            ...
            "public function Set", function (x_, y_) {
                if (arguments.length < 2) {
                    if (arguments.length < 1) {
                        x_ = 0;
                    }
            ...
            "public function GetNegative", function () {
                return new Box2D.Common.Math.b2Vec2(-this.x, -this.y);
            },
            "public function NegativeSelf", function () {
                this.x = -this.x;
                this.y = -this.y;
            },
...
joo.classLoader.prepare(
    "package Box2D.Common.Math",
    "public class b2Vec3", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    ...
    "public class b2Body", 1, function ($$private) {
        var is = joo.is, as = joo.as, assert = joo.assert;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2World);
        },
            ...
            "public function b2Body", function (bd, world) {
                this.m_xf = this.m_xf();
                this.m_sweep = this.m_sweep();
                this.m_linearVelocity = this.m_linearVelocity();
                this.m_force = this.m_force();
                this.m_flags = 0;
                if (bd.bullet) {
                    this.m_flags |= Box2D.Dynamics.b2Body.e_bulletFlag;
                }
            ...
            "static private var", {s_xf1:function () {
                return(new Box2D.Common.Math.b2Transform());
            }},
            ...
            "b2internal var", {m_xf:function () {
                return(new Box2D.Common.Math.b2Transform());
            }},
            "b2internal var", {m_sweep:function () {
                return(new Box2D.Common.Math.b2Sweep());
            }},
            "b2internal var", {m_linearVelocity:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "b2internal var", {m_angularVelocity:NaN},
            "b2internal var", {m_force:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2BodyDef", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2Body);
        },
            ...
            "public var", {linearVelocity:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2BodyEvent extends flash.events.Event", 2, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2ContactEvent extends flash.events.Event", 2, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2ContactFilter", 1, function ($$private) {
        ;
        return[
            ...
            "static b2internal var", {b2_defaultFilter:function () {
                return(new Box2D.Dynamics.b2ContactFilter());
            }},
        ];
    }, [], [], "0.8.0", "0.8.1"
);
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2ContactImpulse", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Common.b2Settings);
        },

            "public var", {normalImpulses:function () {
                return(new Array(Box2D.Common.b2Settings.b2_maxManifoldPoints));
            }},
            "public var", {tangentImpulses:function () {
                return(new Array(Box2D.Common.b2Settings.b2_maxManifoldPoints));
            }},
            "public function b2ContactImpulse", function b2ContactImpulse$() {
                this.normalImpulses = this.normalImpulses();
                this.tangentImpulses = this.tangentImpulses();
            }];
    }, [], ["Array", "Box2D.Common.b2Settings"], "0.8.0", "0.8.1"
);
// class Box2D.Dynamics.b2ContactManager
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2ContactManager", 1, function ($$private) {
        var as = joo.as, $$bound = joo.boundMethod;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2ContactFilter, Box2D.Dynamics.Contacts.b2Contact);
        },
            ...
            "static private const", {s_evalCP:function () {
                return(new Box2D.Collision.b2ContactPoint());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2DebugDraw", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2DefaultContactListener implements Box2D.Dynamics.IContactListener", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2World);
        },
            ...
            "public function b2DefaultContactListener", function (world) {
                this.m_beginContact$1 = this.m_beginContact$1();
                this.m_endContact$1 = this.m_endContact$1();
                this.m_preSolveContact$1 = this.m_preSolveContact$1();
                this.m_postSolveContact$1 = this.m_postSolveContact$1();
            ...
            "private var", {m_beginContact:function () {
                return(new Box2D.Dynamics.b2ContactEvent(Box2D.Dynamics.b2World.BEGINCONTACT));
            }},
            "private var", {m_endContact:function () {
                return(new Box2D.Dynamics.b2ContactEvent(Box2D.Dynamics.b2World.ENDCONTACT));
            }},
            "private var", {m_preSolveContact:function () {
                return(new Box2D.Dynamics.b2PreSolveEvent(Box2D.Dynamics.b2World.PRESOLVE));
            }},
            "private var", {m_postSolveContact:function () {
                return(new Box2D.Dynamics.b2PostSolveEvent(Box2D.Dynamics.b2World.POSTSOLVE));
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2EmptyContactListener implements Box2D.Dynamics.IContactListener", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2FilterData", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2Fixture", 1, function ($$private) {
        ;
        return[
            ...
            "private static var", {s_aabb1:function () {
                return(new Box2D.Collision.b2AABB());
            }},
            "private static var", {s_aabb2:function () {
                return(new Box2D.Collision.b2AABB());
            }},
            "private static var", {s_displacement:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            ...
            "b2internal var", {m_filter:function () {
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2FixtureDef", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2FixtureEvent extends flash.events.Event", 2, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2Island", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2Body, Number, Box2D.Common.b2Settings);
        },
            ...
            "public function Initialize", function (bodyCapacity, contactCapacity, jointCapacity, allocator, listener, contactSolver) {
                var i;
            ...
            "private static var", {s_impulse:function () {
                return(new Box2D.Dynamics.b2ContactImpulse());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2JointEvent extends flash.events.Event", 2, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2PostSolveEvent extends Box2D.Dynamics.b2ContactEvent", 3, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2PreSolveEvent extends Box2D.Dynamics.b2ContactEvent", 3, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2TimeStep", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public class b2World extends flash.events.EventDispatcher", 2, function ($$private) {
        var as = joo.as, assert = joo.assert;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.Joints.b2Joint, Box2D.Dynamics.b2Body, Box2D.Collision.Shapes.b2Shape, Number, Box2D.Dynamics.Contacts.b2Contact, Box2D.Common.b2Settings, Box2D.Dynamics.b2DebugDraw);
        },
            ...
            "public function b2World", function (gravity, doSleep) {
                this.super$2();
                this.s_stack$2 = this.s_stack$2();
                this.m_contactSolver$2 = this.m_contactSolver$2();
                this.m_island$2 = this.m_island$2();
                this.m_preStepEvent$2 = this.m_preStepEvent$2();
                this.m_postStepEvent$2 = this.m_postStepEvent$2();
                this.m_addBodyEvent$2 = this.m_addBodyEvent$2();
                this.m_removeBodyEvent$2 = this.m_removeBodyEvent$2();
                this.m_addFixtureEvent = this.m_addFixtureEvent();
                this.m_removeFixtureEvent = this.m_removeFixtureEvent();
                this.m_addJointEvent$2 = this.m_addJointEvent$2();
                this.m_removeJointEvent$2 = this.m_removeJointEvent$2();
            ...
            "public function SetWarmStarting", function (flag) {
                $$private.m_warmStarting = flag;
            },
            "public function SetContinuousPhysics", function (flag) {
                $$private.m_continuousPhysics = flag;
            },
            ...
            "private static var", {s_timestep2:function () {
                return(new Box2D.Dynamics.b2TimeStep());
            }},
            ...
            "static private var", {s_xf:function () {
                return(new Box2D.Common.Math.b2Transform());
            }},
            ...
            "private static var", {s_backupA:function () {
                return(new Box2D.Common.Math.b2Sweep());
            }},
            "private static var", {s_backupB:function () {
                return(new Box2D.Common.Math.b2Sweep());
            }},
            "private static var", {s_timestep:function () {
                return(new Box2D.Dynamics.b2TimeStep());
            }},
            "private static var", {s_queue:function () {
                return(new Array());
            }},
            ...
            "static private var", {s_jointColor:function () {
                return(new Box2D.Common.b2Color(0.5, 0.8, 0.8));
            }},
            ...
            "private var", {m_contactSolver:function () {
                return(new Box2D.Dynamics.Contacts.b2ContactSolver());
            }},
            "private var", {m_island:function () {
                return(new Box2D.Dynamics.b2Island());
            }},
            ...
            "private var", {m_preStepEvent:function () {
                return(new flash.events.Event(Box2D.Dynamics.b2World.PRESTEP));
            }},
            "private var", {m_postStepEvent:function () {
                return(new flash.events.Event(Box2D.Dynamics.b2World.POSTSTEP));
            }},
            "private var", {m_addBodyEvent:function () {
                return(new Box2D.Dynamics.b2BodyEvent(Box2D.Dynamics.b2World.ADDBODY));
            }},
            "private var", {m_removeBodyEvent:function () {
                return(new Box2D.Dynamics.b2BodyEvent(Box2D.Dynamics.b2World.REMOVEBODY));
            }},
            "b2internal var", {m_addFixtureEvent:function () {
                return(new Box2D.Dynamics.b2FixtureEvent(Box2D.Dynamics.b2World.ADDFIXTURE));
            }},
            "b2internal var", {m_removeFixtureEvent:function () {
                return(new Box2D.Dynamics.b2FixtureEvent(Box2D.Dynamics.b2World.REMOVEFIXTURE));
            }},
            "private var", {m_addJointEvent:function () {
                return(new Box2D.Dynamics.b2JointEvent(Box2D.Dynamics.b2World.ADDJOINT));
            }},
            "private var", {m_removeJointEvent:function () {
                return(new Box2D.Dynamics.b2JointEvent(Box2D.Dynamics.b2World.REMOVEJOINT));
            }},
        ];
...
joo.classLoader.prepare(
    ...
    "public class b2CircleContact extends Box2D.Dynamics.Contacts.b2Contact", 2, function ($$private) {
        var as = joo.as;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Contacts",
    "public class b2Contact", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2Body, Box2D.Common.b2Settings);
        },
            ...
            "public function b2Contact", function () {
                this.m_nodeA = this.m_nodeA();
                this.m_nodeB = this.m_nodeB();
                this.m_manifold = this.m_manifold();
                this.m_oldManifold = this.m_oldManifold();
            },
            ...
            "private static var", {s_input:function () {
                return(new Box2D.Collision.b2TOIInput());
            }},
            ...
            "b2internal var", {m_prev:null},
            "b2internal var", {m_next:null},
            "b2internal var", {m_nodeA:function () {
                return(new Box2D.Dynamics.Contacts.b2ContactEdge());
            }},
            "b2internal var", {m_nodeB:function () {
                return(new Box2D.Dynamics.Contacts.b2ContactEdge());
            }},
            "b2internal var", {m_fixtureA:null},
            "b2internal var", {m_fixtureB:null},
            "b2internal var", {m_manifold:function () {
                return(new Box2D.Collision.b2Manifold());
            }},
            "b2internal var", {m_oldManifold:function () {
                return(new Box2D.Collision.b2Manifold());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Contacts",
    "public class b2ContactConstraint", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Common.b2Settings);
        },

            "public function b2ContactConstraint", function () {
                this.localPlaneNormal = this.localPlaneNormal();
            ...
            "public var", {localPlaneNormal:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {localPoint:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {normal:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {normalMass:function () {
                return(new Box2D.Common.Math.b2Mat22());
            }},
            "public var", {K:function () {
                return(new Box2D.Common.Math.b2Mat22());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Contacts",
    "public class b2ContactConstraintPoint", 1, function ($$private) {
        ;
        return[
            ...
            "public var", {rA:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {rB:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            ...
            "public function b2ContactConstraintPoint", function b2ContactConstraintPoint$() {
                this.localPoint = this.localPoint();
                this.rA = this.rA();
                this.rB = this.rB();
            }];
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Contacts",
    "public class b2ContactEdge", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Contacts",
    "public class b2ContactFactory", 1, function ($$private) {
        var assert = joo.assert;
        return[function () {
            joo.classLoader.init(Box2D.Collision.Shapes.b2Shape, Box2D.Dynamics.Contacts.b2PolygonContact, Box2D.Dynamics.Contacts.b2CircleContact, Box2D.Dynamics.Contacts.b2PolyAndCircleContact);
        },
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Contacts",
    "public class b2ContactRegister", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Contacts",
    "public class b2ContactResult", 1, function ($$private) {
        ;
        return[
            ...
            "public function b2ContactResult", function b2ContactResult$() {
                this.position = this.position();
                this.normal = this.normal();
                this.id = this.id();
            }];
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Contacts",
    "public class b2ContactSolver", 1, function ($$private) {
        var assert = joo.assert;
        return[function () {
            joo.classLoader.init(Box2D.Common.b2Settings);
        },
            ...
            "public function b2ContactSolver", function () {
                ...
                this.m_constraints = this.m_constraints();
            },
            "private static var", {s_worldManifold:function () {
                return(new Box2D.Collision.b2WorldManifold());
            }},
            ...
            "private static var", {s_psm:function () {
                return(new Box2D.Dynamics.Contacts.b2PositionSolverManifold());
            }},
            ...
            "private var", {m_step:function () {
                return(new Box2D.Dynamics.b2TimeStep());
            }},
            "private var", {m_allocator:undefined},
            "b2internal var", {m_constraints:function () {
                return(new Array());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Contacts",
    "public class b2PolyAndCircleContact extends Box2D.Dynamics.Contacts.b2Contact", 2, function ($$private) {
        var as = joo.as, assert = joo.assert;
        return[function () {
            joo.classLoader.init(Box2D.Collision.Shapes.b2Shape);
        },
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Contacts",
    "public class b2PolygonContact extends Box2D.Dynamics.Contacts.b2Contact", 2, function ($$private) {
        var as = joo.as;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Contacts",
    "internal class b2PositionSolverManifold", 1, function ($$private) {
        var assert = joo.assert;
        return[function () {
            joo.classLoader.init(Box2D.Collision.b2Manifold, Number, Box2D.Common.b2Settings);
        },
            ...
            "private static var", {circlePointA:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private static var", {circlePointB:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
...
joo.classLoader.prepare(
    ...
    "public class b2AABBBodyIterable implements Box2D.Dynamics.Controllers.IBodyIterable", 1, function ($$private) {
        var as = joo.as;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Controllers",
    "public class b2BuoyancyController extends Box2D.Dynamics.Controllers.b2Controller", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Number);
        },
            ...
            "public var", {normal:function () {
                return(new Box2D.Common.Math.b2Vec2(0, -1));
            }},
            "public var", {offset:0},
            ...
            "public function b2BuoyancyController", function b2BuoyancyController$() {
                this.super$2();
                this.normal = this.normal();
                this.velocity = this.velocity();
            }];
    }, [], ["Box2D.Dynamics.Controllers.b2Controller", "Box2D.Common.Math.b2Vec2", "Number", "Box2D.Common.b2Color"], "0.8.0", "0.8.1"
);
// class Box2D.Dynamics.Controllers.b2ConstantAccelController
joo.classLoader.prepare(
    "package Box2D.Dynamics.Controllers",
    "public class b2ConstantAccelController extends Box2D.Dynamics.Controllers.b2Controller", 2, function ($$private) {
        ;
        return[
            ...
            "private var", {m_iterator:null},
            "public function b2ConstantAccelController", function b2ConstantAccelController$() {
                this.super$2();
                this.A = this.A();
            }];
    }, [], ["Box2D.Dynamics.Controllers.b2Controller", "Box2D.Common.Math.b2Vec2"], "0.8.0", "0.8.1"
);
// class Box2D.Dynamics.Controllers.b2ConstantForceController
joo.classLoader.prepare(
    "package Box2D.Dynamics.Controllers",
    "public class b2ConstantForceController extends Box2D.Dynamics.Controllers.b2Controller", 2, function ($$private) {
        ;
        return[
            ...
            "private var", {m_iterator:null},
            "public function b2ConstantForceController", function b2ConstantForceController$() {
                this.super$2();
                this.F = this.F();
            }];
    }, [], ["Box2D.Dynamics.Controllers.b2Controller", "Box2D.Common.Math.b2Vec2"], "0.8.0", "0.8.1"
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Controllers",
    "public class b2Controller", 1, function ($$private) {
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Controllers",
    "public class b2GravityController extends Box2D.Dynamics.Controllers.b2Controller", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Number);
        },
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Controllers",
    "public class b2ManualBodyIterable implements Box2D.Dynamics.Controllers.IBodyIterable", 1, function ($$private) {
        var as = joo.as, $$bound = joo.boundMethod;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.b2World);
        },
...
joo.classLoader.prepare("package Box2D.Dynamics.Controllers",
    "internal class b2ManualBodyIterator implements Box2D.Dynamics.Controllers.IBodyIterator", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Controllers",
    "public class b2TensorDampingController extends Box2D.Dynamics.Controllers.b2Controller", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Number);
        },

            "public var", {T:function () {
                return(new Box2D.Common.Math.b2Mat22());
            }},
            ...
            "private var", {m_iterator:null},
            "public function b2TensorDampingController", function b2TensorDampingController$() {
                this.super$2();
                this.T = this.T();
            }];
    }, [], ["Box2D.Dynamics.Controllers.b2Controller", "Box2D.Common.Math.b2Mat22", "Math", "Number", "Box2D.Common.Math.b2Math", "Box2D.Common.Math.b2Vec2"], "0.8.0", "0.8.1"
);
// class Box2D.Dynamics.Controllers.b2TouchingBodyIterable
joo.classLoader.prepare(
    "package Box2D.Dynamics.Controllers",
    "public class b2TouchingBodyIterable implements Box2D.Dynamics.Controllers.IBodyIterable", 1, function ($$private) {
        var as = joo.as;
        return[
            ...
            "internal class b2TouchingBodyIterator implements Box2D.Dynamics.Controllers.IBodyIterator", 1, function ($$private) {
                ;
                return[

                    "public var", {contactEdge:null},
                    "public var", {seen:function () {
                        return(new Array());
                    }},
                    "public function HasNext", function () {
                    ...
                    "public function b2TouchingBodyIterator", function b2TouchingBodyIterator$() {
                        this.seen = this.seen();
                    }];
            }, [], ];
    }, [], ["Box2D.Dynamics.Controllers.IBodyIterable", "Box2D.Dynamics.Controllers.IBodyIterator", "Array"], "0.8.0", "0.8.1"
);
// class Box2D.Dynamics.Controllers.b2WorldBodyIterable
joo.classLoader.prepare(
    "package Box2D.Dynamics.Controllers",
    "public class b2WorldBodyIterable implements Box2D.Dynamics.Controllers.IBodyIterable", 1, function ($$private) {
        var is = joo.is, as = joo.as;
        return[
            ...
            "internal class b2WorldBodyIterator implements Box2D.Dynamics.Controllers.IBodyIterator", 1, function ($$private) {
                ;
                return[
            ...
            "internal class b2FilteringWorldBodyIterator implements Box2D.Dynamics.Controllers.IBodyIterator", 1, function ($$private) {
                ;
                return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Controllers",
    "public interface IBodyIterable", 1, function ($$private) {
        ;
        return[
            , ,
        ];
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Controllers",
    "public interface IBodyIterator", 1, function ($$private) {
        ;
        return[
            , ,
        ];
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public interface IContactListener", 1, function ($$private) {
        ;
        return[
            , , , ,
        ];
...
joo.classLoader.prepare(
    "package Box2D.Dynamics",
    "public interface IDestructionListener", 1, function ($$private) {
        ;
        return[
            , ,
        ];
...
joo.classLoader.prepare(
    ...
    "public class b2DistanceJoint extends Box2D.Dynamics.Joints.b2Joint", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Math, Box2D.Common.b2Settings);
        },
            ...
            "public function b2DistanceJoint", function (def) {
                this.super$2(def);
                this.m_localAnchor1$2 = this.m_localAnchor1$2();
                this.m_localAnchor2$2 = this.m_localAnchor2$2();
                this.m_u$2 = this.m_u$2();
                var tMat;
                var tX;
                var tY;
            ...
            "private var", {m_localAnchor1:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {m_localAnchor2:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {m_u:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2DistanceJointDef extends Box2D.Dynamics.Joints.b2JointDef", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.Joints.b2Joint);
        },

            "public function b2DistanceJointDef", function () {
                this.super$2();
                this.localAnchorA = this.localAnchorA();
                this.localAnchorB = this.localAnchorB();
                this.type = Box2D.Dynamics.Joints.b2Joint.e_distanceJoint;
                this.length = 1.0;
                this.frequencyHz = 0.0;
                this.dampingRatio = 0.0;
            },
            "public function Initialize", function (bA, bB, anchorA, anchorB) {
                this.bodyA = bA;
                this.bodyB = bB;
            ...
            "public var", {localAnchorA:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {localAnchorB:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2FrictionJoint extends Box2D.Dynamics.Joints.b2Joint", 2, function ($$private) {
        ;
        return[
            ...
            "public function b2FrictionJoint", function (def) {
                this.super$2(def);
                this.m_localAnchorA$2 = this.m_localAnchorA$2();
                this.m_localAnchorB$2 = this.m_localAnchorB$2();
                this.m_linearMass = this.m_linearMass();
                this.m_linearImpulse$2 = this.m_linearImpulse$2();
            ...
            "private var", {m_localAnchorA:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {m_localAnchorB:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {m_linearMass:function () {
                return(new Box2D.Common.Math.b2Mat22());
            }},
            "public var", {m_angularMass:NaN},
            "private var", {m_linearImpulse:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2FrictionJointDef extends Box2D.Dynamics.Joints.b2JointDef", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.Joints.b2Joint);
        },
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2GearJoint extends Box2D.Dynamics.Joints.b2Joint", 2, function ($$private) {
        var as = joo.as;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.Joints.b2Joint, Box2D.Common.b2Settings);
        },
            ...
            "public function b2GearJoint", function (def) {
                this.super$2(def);
                this.m_groundAnchor1$2 = this.m_groundAnchor1$2();
                this.m_groundAnchor2$2 = this.m_groundAnchor2$2();
                this.m_localAnchor1$2 = this.m_localAnchor1$2();
                this.m_localAnchor2$2 = this.m_localAnchor2$2();
                this.m_J$2 = this.m_J$2();
            ...
            "private var", {m_groundAnchor1:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {m_groundAnchor2:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {m_localAnchor1:function () {
                return(new Box2D.Common.Math.b2Vec2());
            ...
            "private var", {m_J:function () {
                return(new Box2D.Dynamics.Joints.b2Jacobian());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2GearJointDef extends Box2D.Dynamics.Joints.b2JointDef", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.Joints.b2Joint);
        },
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2Jacobian", 1, function ($$private) {
        ;
        return[

            "public var", {linearA:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {angularA:NaN},
            "public var", {linearB:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            ...
            "public function b2Jacobian", function b2Jacobian$() {
                this.linearA = this.linearA();
                this.linearB = this.linearB();
            }];
    }, [], ["Box2D.Common.Math.b2Vec2"], "0.8.0", "0.8.1"
);
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2Joint", 1, function ($$private) {
        var as = joo.as, assert = joo.assert;
        return[
            ...
            "public virtual function GetAnchorA", function () {
                return null;
            },
            "public virtual function GetAnchorB", function () {
                return null;
            },
            "public virtual function GetReactionForce", function (inv_dt) {
                return null;
            },
            "public virtual function GetReactionTorque", function (inv_dt) {
                return 0.0;
            },
            ...
            "public function b2Joint", function (def) {
                this.m_edgeA = this.m_edgeA();
                this.m_edgeB = this.m_edgeB();
                this.m_localCenterA = this.m_localCenterA();
                this.m_localCenterB = this.m_localCenterB();
            ...
            "b2internal virtual function SolvePositionConstraints", function (baumgarte) {
                return false;
            },
            "b2internal var", {m_type:0},
            "b2internal var", {m_prev:null},
            "b2internal var", {m_next:null},
            "b2internal var", {m_edgeA:function () {
                return(new Box2D.Dynamics.Joints.b2JointEdge());
            }},
            "b2internal var", {m_edgeB:function () {
                return(new Box2D.Dynamics.Joints.b2JointEdge());
            }},
            ...
            "private var", {m_userData:undefined},
            "b2internal var", {m_localCenterA:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "b2internal var", {m_localCenterB:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2JointDef", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.Joints.b2Joint);
        },
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2JointEdge", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2LineJoint extends Box2D.Dynamics.Joints.b2Joint", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Number, Box2D.Common.b2Settings);
        },
            ...
            "public function b2LineJoint", function (def) {
                this.super$2(def);
                this.m_localAnchor1 = this.m_localAnchor1();
                this.m_localAnchor2 = this.m_localAnchor2();
                this.m_localXAxis1 = this.m_localXAxis1();
                this.m_localYAxis1$2 = this.m_localYAxis1$2();
                this.m_axis$2 = this.m_axis$2();
                this.m_perp$2 = this.m_perp$2();
                this.m_K$2 = this.m_K$2();
                this.m_impulse$2 = this.m_impulse$2();
                var tMat;
                var tX;
                var tY;
            ...
            "b2internal var", {m_localAnchor1:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "b2internal var", {m_localAnchor2:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "b2internal var", {m_localXAxis1:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {m_localYAxis1:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {m_axis:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {m_perp:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            ...
            "private var", {m_K:function () {
                return(new Box2D.Common.Math.b2Mat22());
            }},
            "private var", {m_impulse:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2LineJointDef extends Box2D.Dynamics.Joints.b2JointDef", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.Joints.b2Joint);
        },
            ...
            "public function b2LineJointDef", function () {
                ...
                this.localAnchorA = this.localAnchorA();
                this.localAnchorB = this.localAnchorB();
                this.localAxisA = this.localAxisA();
            ...
            "public var", {localAxisA:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2MouseJoint extends Box2D.Dynamics.Joints.b2Joint", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Math);
        },
            ...
            "public function b2MouseJoint", function (def) {
                ...
                this.K1$2 = this.K1$2();
                this.K2$2 = this.K2$2();
                this.m_localAnchor$2 = this.m_localAnchor$2();
                this.m_target$2 = this.m_target$2();
                this.m_impulse$2 = this.m_impulse$2();
                this.m_mass$2 = this.m_mass$2();
                this.m_C$2 = this.m_C$2();
            ...
            "private var", {K1:function () {
                return(new Box2D.Common.Math.b2Mat22());
            }},
            "private var", {K2:function () {
                return(new Box2D.Common.Math.b2Mat22());
            }},
            "b2internal override function InitVelocityConstraints", function (step) {
                var b = this.m_bodyB;
                ...
                var invI = b.m_invI;
                this.K1$2.col1.x = invMass;
                this.K1$2.col2.x = 0.0;
                this.K1$2.col1.y = 0.0;
                this.K1$2.col2.y = invMass;
                this.K2$2.col1.x = invI * rY * rY;
                this.K2$2.col2.x = -invI * rX * rY;
                this.K2$2.col1.y = -invI * rX * rY;
                this.K2$2.col2.y = invI * rX * rX;
            ...
            "private var", {m_localAnchor:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {m_target:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {m_impulse:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {m_mass:function () {
                return(new Box2D.Common.Math.b2Mat22());
            }},
            "private var", {m_C:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {m_maxForce:NaN},
            "private var", {m_frequencyHz:NaN},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2MouseJointDef extends Box2D.Dynamics.Joints.b2JointDef", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.Joints.b2Joint);
        },
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2PrismaticJoint extends Box2D.Dynamics.Joints.b2Joint", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Number, Box2D.Common.b2Settings);
        },
            ...
            "private static var", {s_f2r:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private static var", {s_f1:function () {
                return(new Box2D.Common.Math.b2Vec3());
            }},
            "b2internal override function SolveVelocityConstraints", function (step) {
                var bA = this.m_bodyA;
            ...
            "private static var", {s_R1:function () {
                return(new Box2D.Common.Math.b2Mat22());
            }},
            "private static var", {s_R2:function () {
                return(new Box2D.Common.Math.b2Mat22());
            }},
            "private static var", {s_vec3:function () {
                return(new Box2D.Common.Math.b2Vec3());
            }},
            "b2internal override function SolvePositionConstraints", function (baumgarte) {
                var limitC;
            ...
            "private var", {m_a2:NaN},
            "private var", {m_K:function () {
                return(new Box2D.Common.Math.b2Mat33());
            }},
            "private var", {m_impulse:function () {
                return(new Box2D.Common.Math.b2Vec3());
            }},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2PrismaticJointDef extends Box2D.Dynamics.Joints.b2JointDef", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.Joints.b2Joint);
        },
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2PulleyJoint extends Box2D.Dynamics.Joints.b2Joint", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Common.b2Settings);
        },
            ...
            "public function b2PulleyJoint", function (def) {
                ...
                this.m_localAnchor1$2 = this.m_localAnchor1$2();
                this.m_localAnchor2$2 = this.m_localAnchor2$2();
                this.m_u1$2 = this.m_u1$2();
                this.m_u2$2 = this.m_u2$2();
                var tMat;
                var tX;
                var tY;
            ...
            "private var", {m_u1:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {m_u2:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {m_constant:NaN},
            "private var", {m_ratio:NaN},
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2PulleyJointDef extends Box2D.Dynamics.Joints.b2JointDef", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.Joints.b2Joint, Box2D.Dynamics.Joints.b2PulleyJoint);
        },

            "public function b2PulleyJointDef", function () {
                this.super$2();
                this.groundAnchorA = this.groundAnchorA();
                this.groundAnchorB = this.groundAnchorB();
                this.localAnchorA = this.localAnchorA();
                this.localAnchorB = this.localAnchorB();
            ...
            "public function Initialize", function (bA, bB, gaA, gaB, anchorA, anchorB, r) {
                this.bodyA = bA;
                this.bodyB = bB;
            ...
            "public var", {groundAnchorA:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {groundAnchorB:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "public var", {localAnchorA:function () {
                return(new Box2D.Common.Math.b2Vec2());
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2RevoluteJoint extends Box2D.Dynamics.Joints.b2Joint", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Common.b2Settings);
        },
            ...
            "public function b2RevoluteJoint", function (def) {
                ...
                this.K2$2 = this.K2$2();
                this.K3$2 = this.K3$2();
                this.impulse3$2 = this.impulse3$2();
                this.impulse2$2 = this.impulse2$2();
                this.reduced$2 = this.reduced$2();
                this.m_localAnchor1 = this.m_localAnchor1();
                this.m_localAnchor2 = this.m_localAnchor2();
                this.m_impulse$2 = this.m_impulse$2();
                this.m_mass$2 = this.m_mass$2();
            ...
            "private var", {impulse3:function () {
                return(new Box2D.Common.Math.b2Vec3());
            }},
            "private var", {impulse2:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "private var", {reduced:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "b2internal override function SolveVelocityConstraints", function (step) {
                var bA = this.m_bodyA;
            ...
            "private static var", {tImpulse:function () {
                return(new Box2D.Common.Math.b2Vec2());
            }},
            "b2internal override function SolvePositionConstraints", function (baumgarte) {
                var oldLimitImpulse;
                ...
                }
                {
                    ...
                    this.K1$2.col1.x = invMass1 + invMass2;
                    this.K1$2.col2.x = 0.0;
                    this.K1$2.col1.y = 0.0;
                    this.K1$2.col2.y = invMass1 + invMass2;
                    this.K2$2.col1.x = invI1 * r1Y * r1Y;
                    this.K2$2.col2.x = -invI1 * r1X * r1Y;
                    this.K2$2.col1.y = -invI1 * r1X * r1Y;
                    this.K2$2.col2.y = invI1 * r1X * r1X;
                    this.K3$2.col1.x = invI2 * r2Y * r2Y;
                    this.K3$2.col2.x = -invI2 * r2X * r2Y;
                    this.K3$2.col1.y = -invI2 * r2X * r2Y;
                    this.K3$2.col2.y = invI2 * r2X * r2X;
                    this.K$2.SetM(this.K1$2);
                    this.K$2.AddM(this.K2$2);
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2RevoluteJointDef extends Box2D.Dynamics.Joints.b2JointDef", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.Joints.b2Joint);
        },
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2WeldJoint extends Box2D.Dynamics.Joints.b2Joint", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Common.b2Settings);
        },
...
joo.classLoader.prepare(
    "package Box2D.Dynamics.Joints",
    "public class b2WeldJointDef extends Box2D.Dynamics.Joints.b2JointDef", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(Box2D.Dynamics.Joints.b2Joint);
        },
