        ...
        prepare:function (packageDef, classDef, inheritanceLevel, memberFactory, publicStaticMethodNames, dependencies, runtimeApiVersion, compilerVersion) {
            ...
            for (var i = 0; i < members.length; ++i) {
                ...
                switch (typeof memberDeclaration) {
                    case "function":
                        staticInitializer = memberDeclaration;
                        break;
                    case "string":
...
joo.classLoader.prepare(
    "package joo",
    "public class MemberDeclaration", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(RegExp, Object);
        },
            "public static const", {
                METHOD_TYPE_GET:"get",
                METHOD_TYPE_SET:"set",
            ...
            "internal var", {
                _namespace:function () {
                    return(joo.MemberDeclaration.NAMESPACE_INTERNAL);
                },
                _static:false,
                _final:false,
                _native:false,
            ...
            "public var", {
                ...
                slot:null,
                value:undefined},
            "public var", {metadata:function () {
                return({});
            }},
            "public function MemberDeclaration", function (tokens) {
...
joo.classLoader.prepare(
    "package joo",
    "public class NativeClassDeclaration", 1, function ($$private) {
        var trace = joo.trace;
        return[function () {
            joo.classLoader.init(Error);
        },
            ...
            "public var", {
                ...
                state:function () {
                    return(joo.NativeClassDeclaration.STATE_LOADED);
                },
                Public:null,
                superClassDeclaration:null,
                Types:null,
                interfaces:null},
            "public function NativeClassDeclaration", function () {
...
joo.classLoader.prepare(
    "package joo",
    "public class JooClassDeclaration extends joo.NativeClassDeclaration", 2, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(joo.MemberDeclaration, Object);
        },
            "protected var", {
                package_:null,
                type:function () {
                    return(joo.MemberDeclaration.MEMBER_TYPE_CLASS);
                },
                namespace_:function () {
                    return(joo.MemberDeclaration.NAMESPACE_INTERNAL);
                },
            ...
            "public function JooClassDeclaration", function (packageDef, classDef, inheritanceLevel, memberDeclarations, publicStaticMethodNames, dependencies) {
                this.super$2();
            ...
            "internal function createInitializingStaticMethod", function (methodName) {
                var this$ = this;
...
joo.classLoader.prepare(
    "package joo",
    "public class SystemClassLoader", 1, function ($$private) {
        ;
        return[function () {
            joo.classLoader = new joo.SystemClassLoader();
        },
            "public static const", {classDeclarationsByName:function () {
                return({});
            }},
            ...
            "protected function createClassDeclaration", function (packageDef, classDef, inheritanceLevel, memberFactory, publicStaticMethodNames, dependencies) {
...
joo.classLoader.prepare("package",
    "public dynamic class ArgumentError extends Error", 2, function ($$private) {
        ;
        return[
            "public function ArgumentError", function (message) {
...
joo.classLoader.prepare("package",
    "public dynamic class DefinitionError extends Error", 2, function ($$private) {
        ;
        return[
            "public function DefinitionError", function (message) {
                if (arguments.length < 1) {
                    message = "";
                }
                this.super$2(message);
...
joo.classLoader.prepare("package",
    "public dynamic class SecurityError extends Error", 2, function ($$private) {
        ;
        return[
            "public function SecurityError", function (message) {
                if (arguments.length < 1) {
                    message = "";
                }
                this.super$2(message);
...
joo.classLoader.prepare(
    "package",
    "public dynamic class Array", 1, function ($$private) {
        ;
        return[
            ...
            "public function every", function (callback, thisObject) {
            ...
            "public function indexOf", function (searchElement, fromIndex) {
                if (arguments.length < 2) {
                    fromIndex = 0;
                }
                var len = this.length;
            ...
            "public function lastIndexOf", function (searchElement, fromIndex) {
                if (arguments.length < 2) {
                    fromIndex = 0x7fffffff;
                }
                var len = this.length;
            ...
            "public function map", function (callback, thisObject) {
                if (arguments.length < 2) {
                    thisObject = null;
                }
                var results = [];
            ...
            "public function some", function (callback, thisObject) {
                if (arguments.length < 2) {
                    thisObject = null;
                }
                var i = 0,
...
joo.classLoader.prepare(
    "package",
    "public final dynamic class Date", 1, function ($$private) {
        ;
        return[
...
joo.classLoader.prepare(
    "package joo",
    "public class StandardClassLoader extends joo.SystemClassLoader", 2, function ($$private) {
        ;
        return[
            "private static var", {classDeclarations:function () {
                return([]);
            }},
            "private var", {imports:null},
            "public function StandardClassLoader", function () {
                this.super$2();
                this.imports$2 = [];
            },
            "override protected function createClassDeclaration", function (packageDef, classDef, inheritanceLevel, memberFactory, publicStaticMethodNames, dependencies) {
            ...
            "public function run", function (mainClassName) {
                var this$ = this;
            ...
            "public override function init", function () {
                var classes = arguments;
                var clazz;
...
joo.classLoader.prepare(
    "package joo",
    "public class DynamicClassLoader extends joo.StandardClassLoader", 3, function ($$private) {
        var trace = joo.trace;
        return[
            ...
            "private var", {resourceByPath:function () {
                return({});
            }},
            "private var", {onCompleteCallbacks:function () {
                return([]);
            }},
            "public function DynamicClassLoader", function () {
                this.super$3();
                this.resourceByPath$3 = this.resourceByPath$3();
                this.onCompleteCallbacks$3 = this.onCompleteCallbacks$3();
                this.pendingDependencies$3 = this.pendingDependencies$3();
                this.pendingClassState$3 = this.pendingClassState$3();
                joo.classLoader = joo.DynamicClassLoader.INSTANCE = this;
            },
            "private var", {pendingDependencies:function () {
                return([]);
            }},
            "private var", {pendingClassState:function () {
                return({});
            }},
            "override public function prepare", function () {
                var params = arguments;
            ...
            "override protected function doCompleteCallbacks", function (onCompleteCallbacks) {
                var this$ = this;
            ...
            "private function createClassLoadErrorHandler", function (fullClassName, url) {
                var this$ = this;
                return function () {
            ...
            "override public function run", function (mainClassName) {
                var args = Array.prototype.slice.call(arguments, 1);
            ...
            "private static const", {RESOURCE_TYPE_BY_EXTENSION:function () {
                return({
            ...
            "private function loadResource", function (path) {
                var this$ = this;
                var this$ = this;
            ...
            "private static const", {AUDIO_FALLBACK_ORDER:function () {
                return(["mp3", "ogg", "wav"]);
            }},
...
joo.classLoader.prepare(
    "package joo",
    "public class ResourceBundleAwareClassLoader extends joo.DynamicClassLoader", 4, function ($$private) {
        ;
        return[function () {
            joo.classLoader.init(joo.localization, joo.NativeClassDeclaration);
        },
            ...
            "public function ResourceBundleAwareClassLoader", function (supportedLocales, localeCookieName, localeCookiePath, localeCookieDomain) {
            ...
            "private function setCookie", function (name, value, path, expires, domain, secure) {
