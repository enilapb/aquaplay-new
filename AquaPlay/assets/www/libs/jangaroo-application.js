...
// FROM net.jangaroo:jooflash:0.8.2:
joo.loadScript("joo/net.jangaroo.jooflash-native.js");
joo.loadModule("net.jangaroo", "jooflash");

// FROM net.jangaroo.flash:box2d:0.8.0-SNAPSHOT:
joo.loadModule("net.jangaroo.flash", "box2d");

// FROM net.jangaroo.flash.examples:box2d-examples:0.8.0-SNAPSHOT:
joo.loadModule("net.jangaroo.flash.examples", "box2d-examples");
